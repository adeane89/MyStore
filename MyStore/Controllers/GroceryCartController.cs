    ...
    public class GroceryCartController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                model = await _context.GroceryCart.Include(x => x.GroceryCartProducts).ThenInclude(x => x.GroceryProducts).FirstOrDefaultAsync(x => x.ApplicationUserID == currentUser.Id);
            }
