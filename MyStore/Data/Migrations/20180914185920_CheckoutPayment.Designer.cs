...
namespace MyStore.Data.Migrations
{
    ...
    [Migration("20180914185920_CheckoutPayment")]
    partial class CheckoutPayment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Models.GroceryOrder", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyStore.Models.GroceryOrderProduct", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<Guid>("GroceryOrderID");
                    ...
                    b.ToTable("GroceryOrderProducts");
                });
            ...
            modelBuilder.Entity("MyStore.Models.GroceryCartProducts", b =>
                {
                    ...
                    b.HasOne("MyStore.Models.GroceryProducts", "GroceryProduct")
                        .WithMany("GroceryCartProducts")
            ...
            modelBuilder.Entity("MyStore.Models.GroceryOrderProduct", b =>
                {
                    b.HasOne("MyStore.Models.GroceryOrder", "GroceryOrder")
                        .WithMany("GroceryOrderProducts")
